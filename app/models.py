...
class Employee(db.Model, UserMixin):   # inheriting UserMixin properties/methods, used in /routes/session.py (https://stackoverflow.com/questions/63231163/what-is-the-usermixin-in-flask)
